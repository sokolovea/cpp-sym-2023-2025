...
Если до прохождения курса школьники ни разу не программировали, то количество рассматриваемых тем уменьшалось и не рассматривались продвинутые возможности языка, введение в алгоритмы, сети и т.п..
